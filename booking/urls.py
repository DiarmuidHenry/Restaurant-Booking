...
from .views import ReservationView, check_availability, home, thank_you, make_reservation, get_opening_hours, current_reservations, cancel_reservation, cancellation_confirmed, contact, contact_success, edit_reservation
